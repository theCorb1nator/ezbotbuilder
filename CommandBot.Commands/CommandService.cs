...
namespace Teams.Commands
{
    public class CommandService : IDisposable
    {
        ...
        ///     command execution.
        /// </returns>
        public async Task<IResult> ExecuteAsync(ITurnContext context, string input, IServiceProvider services, MultiMatchHandling multiMatchHandling = MultiMatchHandling.Exception)
        {
            services = services ?? EmptyServiceProvider.Instance;
